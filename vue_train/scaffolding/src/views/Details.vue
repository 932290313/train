  ...
  <div>
    ...
    <div class="bj">
      <div>
        ...
        <div class="felx">
          <div>
            <span class="font">北京南</span>
            <img src="../assets/icon/dshi.png" alt="" />
            <p class="font1">10:00</p>
          ...
          <div>
            ...
            <span class="font">上海虹站</span>
            <p class="font1">14:28</p>
...
export default {
  data(){
    return{
      times:'' ,
      day:17,
      dayss:['星期一','星期二','星期三','星期四','星期五','星期六','星期日'],
      getday:4
    }
  },
  methods:{
    ...
    days(){
       let date=new Date();    
      this.times=(date.getMonth()+1)+'月'+this.day+'日'+this.dayss[this.getday];
    },
    shop(){
